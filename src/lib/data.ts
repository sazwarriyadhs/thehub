...
export const inventoryItems: InventoryItem[] = [
  // Devices
  { id: 'inv-001', name: 'Sofwave™', type: 'Device', quantity: 3, purchaseDate: '2023-01-15', warrantyEndDate: '2025-01-15', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Sofwave-1.png', description: 'Ultrasonik non-invasif untuk skin lifting, penghapusan garis halus, dan pengencangan kulit, termasuk wajah dan leher.', clientId: 'cli-001' },
  { id: 'inv-002', name: 'Indiba Deep Care', type: 'Device', quantity: 1, purchaseDate: '2023-02-20', warrantyEndDate: '2025-02-20', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Indiba-Deep-Care-1.png', description: 'Radio-frequency untuk perawatan tubuh, membantu pengurangan lingkar tubuh & pemulihan lebih cepat.', clientId: 'cli-003' },
  { id: 'inv-003', name: 'Vbeam Perfecta®', type: 'Device', quantity: 2, purchaseDate: '2022-11-20', warrantyEndDate: '2024-11-20', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Vbeam-Prima.png', description: 'Laser PDL untuk perawatan pigmentasi, flek, bekas jerawat, rosacea, stretch mark, dan masih banyak lagi.' },
  { id: 'inv-004', name: 'PicoWay®', type: 'Device', quantity: 1, purchaseDate: '2023-08-01', warrantyEndDate: '2025-08-01', status: 'In Stock', imageUrl: 'https://aspmedica.com/wp-content/uploads/2023/11/PicoWay-1.jpg', description: 'Laser pico-second untuk melasma, pigmentasi, dan hapus tato.', clientId: 'cli-004' },
  ...
  { id: 'inv-007', name: 'Morpheus8', type: 'Device', quantity: 2, purchaseDate: '2023-06-12', warrantyEndDate: '2025-06-12', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Morpheus8-1.png', description: 'Kombinasi microneedling dan RF untuk mengatasi garis halus dan selulit.', clientId: 'cli-001' },
