...
export const inventoryItems: InventoryItem[] = [
  // Devices
  { id: 'inv-001', name: 'Sofwave™', type: 'Device', quantity: 3, purchaseDate: '2023-01-15', warrantyEndDate: '2025-01-15', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Sofwave-1.png', description: '3D Ultrasound for face/neck lifting, fine lines, and cellulite.', clientId: 'cli-001' },
  { id: 'inv-002', name: 'Indiba Deep Care', type: 'Device', quantity: 1, purchaseDate: '2023-02-20', warrantyEndDate: '2025-02-20', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Indiba-Deep-Care-1.png', description: 'Radio Frequency for body contouring, cellulite, post-surgery care, and circumference reduction.', clientId: 'cli-003' },
  { id: 'inv-003', name: 'Vbeam Perfecta®', type: 'Device', quantity: 2, purchaseDate: '2022-11-20', warrantyEndDate: '2024-11-20', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Vbeam-Prima.png', description: 'Pulsed-Dye Laser (PDL) for rosacea, vascular issues, pigmentation, acne scars, and keloids.' },
  { id: 'inv-004', name: 'PicoWay®', type: 'Device', quantity: 1, purchaseDate: '2023-08-01', warrantyEndDate: '2025-08-01', status: 'In Stock', imageUrl: 'https://aspmedica.com/wp-content/uploads/2023/11/PicoWay-1.jpg', description: 'Picosecond Laser for pigmentation (melasma, nevi), tattoo removal, and collagen remodeling.', clientId: 'cli-004' },
  { id: 'inv-005', name: 'BiAxis QS™', type: 'Device', quantity: 1, purchaseDate: '2023-09-10', warrantyEndDate: '2025-09-10', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Q-switched Laser for acne scars, freckles, pigmentation, and tattoo removal.' },
  ...
  { id: 'inv-007', name: 'Morpheus8', type: 'Device', quantity: 2, purchaseDate: '2023-06-12', warrantyEndDate: '2025-06-12', status: 'In Stock', imageUrl: 'https://regenesis.co.id/wp-content/uploads/2023/06/Morpheus8-1.png', description: 'RF Microneedling for wrinkles, skin laxity, and cellulite.', clientId: 'cli-001' },
  { id: 'inv-008', name: 'Frax Pro', type: 'Device', quantity: 2, purchaseDate: '2024-03-01', warrantyEndDate: '2026-03-01', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Non-ablative fractional laser for skin resurfacing, improving texture, and collagen stimulation.' },
  { id: 'inv-009', name: 'Divine Pro', type: 'Device', quantity: 1, purchaseDate: '2024-05-10', warrantyEndDate: '2026-05-10', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Multi-treatment platform for facial rejuvenation, dermal volumizing, and skin firming.' },
  { id: 'inv-010', name: 'OxyGeneo & Pollogen', type: 'Device', quantity: 3, purchaseDate: '2024-06-20', warrantyEndDate: '2026-06-20', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Combines Oxygenation, RF, and Ultrasound for skin brightening, pigmentation, and anti-aging.' },
  { id: 'inv-011', name: 'BiAxis Pico™', type: 'Device', quantity: 2, purchaseDate: '2024-07-01', warrantyEndDate: '2026-07-01', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Picosecond Laser for pigmentation (melasma, nevi), tattoo, and collagen remodeling.' },
  { id: 'inv-012', name: 'Laser Biaxis QS', type: 'Device', quantity: 1, purchaseDate: '2024-02-15', warrantyEndDate: '2026-02-15', status: 'In Stock', imageUrl: 'https://placehold.co/600x400.png', description: 'Laser for improving melasma, pigmentation, and tattoo removal with minimal downtime.', clientId: 'cli-002' },
